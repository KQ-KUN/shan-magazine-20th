...
(function () {
    ...
    try {
        ...
        var manifestFile = File(root + "/assets/YUELING_MEDIA_MANIFEST.json"), manifest;
        ...
        SHAN.feature.create(doc, File(root + "/manuscripts/09_feature_越岭_几华里.docx"), "feature_beyond_ridge", manifest, root);
        alert("Feature 共用积木测试；未保存或导出。\n" + doc.extractLabel("SHAN_FEATURE_REPORT") + "\n\n" + doc.extractLabel("SHAN_VISUAL_FONTS") + "\n\n" + context.warnings.join("\n"));
    } catch (e) { alert("Feature 未完成：" + e.message + "\n行号：" + e.line); throw e; }
