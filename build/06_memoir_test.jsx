...
(function () {
    ...
    try {
        ...
        var manifestFile = File(root + "/assets/GLOOMY_MEDIA_MANIFEST.json");
        manifestFile.encoding = "UTF-8";
        if (!manifestFile.open("r")) { throw new Error("Cannot read Gloomy media manifest"); }
        var media;
        ...
        SHAN.memoir.create(
            doc,
            File(root + "/manuscripts/07_memoir_Gloomy_Biologist_Cry_笠原JunE_CLEAN.docx"),
            "memoir_gloomy_biologist_cry",
