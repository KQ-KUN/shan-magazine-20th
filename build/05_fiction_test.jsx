...
(function () {
    ...
    try {
        ...
        SHAN.fiction.create(doc, File(root + "/manuscripts/04_fiction_四叠半_笠原JunE.docx"), "fiction_fourfold");
        alert("Fiction 共用积木测试；未保存或导出。\n" + doc.extractLabel("SHAN_FICTION_REPORT") + "\n\n" + doc.extractLabel("SHAN_VISUAL_FONTS") + "\n\n" + context.warnings.join("\n"));
    } catch (e) { alert("Fiction 未完成：" + e.message + "\n行号：" + e.line); throw e; }
