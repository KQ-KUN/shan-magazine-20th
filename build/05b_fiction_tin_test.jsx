...
(function () {
    ...
    try {
        ...
        SHAN.fiction.create(doc, File(root + "/manuscripts/05_fiction_锡兵_张钧寒.docx"), "fiction_tin_soldier");
        alert("Fiction《锡兵》复用测试；未保存或导出。\n" + doc.extractLabel("SHAN_FICTION_REPORT") + "\n\n" + doc.extractLabel("SHAN_VISUAL_FONTS") + "\n\n" + context.warnings.join("\n"));
    } catch (e) { alert("Fiction《锡兵》未完成：" + e.message + "\n行号：" + e.line); throw e; }
